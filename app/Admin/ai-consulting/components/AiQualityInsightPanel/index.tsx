  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center px-4 py-6">
      <button
        ...
        className="absolute inset-0 cursor-default bg-[#020817]/75 backdrop-blur-[6px]"
        onClick={onClose}
      />

      <section className="relative z-10 flex max-h-[calc(100dvh-32px)] w-[min(1040px,calc(100vw-32px))] flex-col overflow-hidden rounded-2xl border border-[var(--admin-card-border)] bg-[var(--admin-card-bg)] text-[var(--admin-strong-text)] shadow-[0_24px_80px_-40px_rgba(0,0,0,0.85)] [.admin-ripple-theme-shell[data-admin-theme=dark]_&]:border-[#1E293B] [.admin-ripple-theme-shell[data-admin-theme=dark]_&]:bg-[#0B132B]">
        <header className="flex shrink-0 items-start justify-between gap-4 border-b border-[var(--admin-card-border)] bg-[var(--admin-card-bg)] px-5 py-4 [.admin-ripple-theme-shell[data-admin-theme=dark]_&]:border-[#1E293B] [.admin-ripple-theme-shell[data-admin-theme=dark]_&]:bg-[#0B132B]">
        ...
        <div className="min-h-0 flex-1 overflow-y-auto bg-[var(--admin-card-soft-bg)] px-5 py-4 [.admin-ripple-theme-shell[data-admin-theme=dark]_&]:bg-[#070D1E]">
          ...
          <div className="mt-4 grid grid-cols-1 gap-4 lg:grid-cols-2">
            <article className="rounded-2xl border border-[var(--admin-soft-panel-border)] bg-[var(--admin-soft-panel)] p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] [.admin-ripple-theme-shell[data-admin-theme=dark]_&]:border-[#1E293B] [.admin-ripple-theme-shell[data-admin-theme=dark]_&]:bg-[#0B132B]">
          ...
          <div className="mt-4 grid grid-cols-1 gap-4 lg:grid-cols-[minmax(0,1fr)_360px]">
            <section className="rounded-2xl border border-[var(--admin-soft-panel-border)] bg-[var(--admin-soft-panel)] p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] [.admin-ripple-theme-shell[data-admin-theme=dark]_&]:border-[#1E293B] [.admin-ripple-theme-shell[data-admin-theme=dark]_&]:bg-[#0B132B]">
              <div className="flex items-center gap-2">
              ...
              <ul className="mt-3 space-y-2.5">
                {session.analysisReasons.map((reason) => (
                  <li
                    key={reason}
                    className="flex gap-2 rounded-xl border border-[var(--admin-soft-panel-border)] bg-[var(--admin-control-bg)] px-3 py-2.5 text-sm font-semibold leading-6 text-[var(--admin-theme-text)] [.admin-ripple-theme-shell[data-admin-theme=dark]_&]:border-[#1E293B] [.admin-ripple-theme-shell[data-admin-theme=dark]_&]:bg-[#101B34]"
                  >
        ...
        <footer className="flex shrink-0 flex-col gap-2 border-t border-[var(--admin-card-border)] bg-[var(--admin-card-bg)] px-5 py-4 sm:flex-row sm:justify-end [.admin-ripple-theme-shell[data-admin-theme=dark]_&]:border-[#1E293B] [.admin-ripple-theme-shell[data-admin-theme=dark]_&]:bg-[#0B132B]">
          <button
            type="button"
            onClick={onClose}
