...
import { getAccessLevelLabel } from "../../technical-documents/lib/technicalDocumentHelpers";
import type { TechnicalDocumentItem } from "../../technical-documents/types/technicalDocument.types";
...
export default function RagKnowledgeTable({
  data,
  total,
  onViewDetail,
}: Props) {
    ...
    return (
      <section className="admin-card flex min-h-[260px] flex-col items-center justify-center rounded-3xl border-dashed p-8 text-center">
        ...
        <p className="mt-2 max-w-md text-[15px] font-medium leading-7 text-[var(--admin-muted-text)]">
          Hiện tại chưa có tài liệu nào trong kho tri thức RAG.
        </p>
      </section>
    );
  }
