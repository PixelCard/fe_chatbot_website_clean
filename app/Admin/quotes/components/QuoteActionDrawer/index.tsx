          ...
          <div className="grid auto-rows-min gap-4 xl:grid-cols-2">
            ...
            <section className="rounded-2xl border border-[var(--admin-soft-panel-border)] bg-[var(--admin-soft-panel)] p-4 [.admin-ripple-theme-shell[data-admin-theme=dark]_&]:border-[#1E2A3F] [.admin-ripple-theme-shell[data-admin-theme=dark]_&]:bg-[#0D1728]">
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0">
                  <p className="text-sm font-bold text-[var(--admin-strong-text)] [.admin-ripple-theme-shell[data-admin-theme=dark]_&]:text-white">
                    Thao tác báo giá
                  </p>
                  <p className="mt-1 text-sm font-medium leading-6 text-[#344054] [.admin-ripple-theme-shell[data-admin-theme=dark]_&]:text-[#94A3B8]">
                    Thao tác báo giá sẽ được bổ sung sau.
                  </p>
                </div>

                <span className="shrink-0 rounded-full border border-[var(--admin-soft-panel-border)] px-3 py-1 text-xs font-bold text-[#667085] [.admin-ripple-theme-shell[data-admin-theme=dark]_&]:border-[#1E2A3F] [.admin-ripple-theme-shell[data-admin-theme=dark]_&]:text-[#94A3B8]">
                  Soon
                </span>
              </div>
            </section>
